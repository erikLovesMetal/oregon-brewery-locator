...
class BreweriesControllerTest < ActionController::TestCase
  ...
  test "should create brewery" do
    assert_difference('Brewery.count') do
      post :create, brewery: { lat: @brewery.lat, long: @brewery.long, name: @brewery.name, notes: @brewery.notes }
    end
  ...
  test "should update brewery" do
    patch :update, id: @brewery, brewery: { lat: @brewery.lat, long: @brewery.long, name: @brewery.name, notes: @brewery.notes }
    assert_redirected_to brewery_path(assigns(:brewery))
  end
